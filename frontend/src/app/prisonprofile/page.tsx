        ...
        <div className="px-4 py-6 md:px-6">
          ...
          <div className="mt-6 grid gap-6 md:grid-cols-2">
            <div>
              ...
              <div className="space-y-3">
                ...
                <div>
                  <strong className="text-gray-600 dark:text-gray-300">Emergency Contact:</strong>
                  <span className="ml-2">{prisoner.emergencyContact}</span>
                </div>
                <div>
                  <strong className="text-gray-600 dark:text-gray-300">Language:</strong>
            ...
            <div>
              ...
              <div className="space-y-3">
                <div>
                  <strong className="text-gray-600 dark:text-gray-300">Crime:</strong>
                  <span className="ml-2">{prisoner.crime}</span>
                </div>
                <div>
                  <strong className="text-gray-600 dark:text-gray-300">Case ID:</strong>
                  <span className="ml-2">{prisoner.caseId}</span>
                </div>
                <div>
                  <strong className="text-gray-600 dark:text-gray-300">Medical Info:</strong>
          ...
          <div className="mt-6 rounded-lg bg-gray-50 p-4 dark:bg-gray-700">
            <p className="text-sm italic text-gray-600 dark:text-gray-300">
              Note: This information is based on available records and is subject to legal proceedings.
            </p>
          </div>
        </div>
      </div>
